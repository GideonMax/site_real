...
import setCountryDataAdmin from './countryDataAdmin.js';
import * as CommentApi from './ForumApi.js';
//#endregion
//const Maps=H;
//let apiKey = "PMFoDa_dg5LnVM4X9dVHmZuzLg_haag5crYUoYoregg";
class AdminMapElement extends HTMLElement {
    constructor() {
        super();
    ...
    PopUpEditWindow() {
        ...
        if (country.exists) {
            this.textbox.value = country.OfficialArticle;
            this.TitleBox.value=country.CountryName;
        }
    ...
    SubmitArticleChange() {
        this.country.OfficialArticle = this.textbox.value;
        this.country.CountryName = this.TitleBox.value;
        setCountryDataAdmin(this.country.code, this.country).then(() => {
...
window.customElements.define("admin-map", AdminMapElement);